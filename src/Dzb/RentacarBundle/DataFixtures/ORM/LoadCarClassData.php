...
namespace Dzb\RentacarBundle\DataFixtures\ORM;

use Doctrine\Common\DataFixtures\AbstractFixture;
use Doctrine\Common\DataFixtures\OrderedFixtureInterface;
use Doctrine\Common\Persistence\ObjectManager;
use Dzb\RentacarBundle\Entity\CarClass;
...
class LoadCarClassData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $carClass1->setImage('bundles/dzbrentacar/images/car/prius.png');
        ...
        $carClass2->setImage('bundles/dzbrentacar/images/car/estima.png');
